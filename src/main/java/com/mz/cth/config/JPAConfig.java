...
@Configuration
@EnableJpaRepositories("com.mz.cth.repository")
...
public class JPAConfig {
	...
	public DataSource dataSource() throws IllegalStateException, PropertyVetoException {
		...
		dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/device");
		dataSource.setUser("root");
		dataSource.setPassword("sinistro");
		return dataSource;
	}
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
		...
		entityManagerFactoryBean.setPackagesToScan("com.mz.cth.model");
